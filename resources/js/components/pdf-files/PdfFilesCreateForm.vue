<template>
    <div class="overflow-hidden overflow-x-auto min-w-full align-middle sm:rounded">
        ...
        <form enctype="multipart/form-data" @submit.prevent="savePdfFile">
            <div class="mb-6">
            ...
            <div class="mb-6">
                ...
                <input 
                    ...
                    ref="file"
                />
                <div class="mt-1 text-sm text-gray-500" id="user_avatar_help">This input only accepts .pdf files.</div>
            </div>
